...
public class ArrayList<T> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arrayList.add(100));
        System.out.println(arrayList.add(200));
        System.out.println(arrayList.add(300));
        System.out.println(arrayList.add(400));
        System.out.println(arrayList.add(500));
